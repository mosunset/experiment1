...
public class Lesson27_2 {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 3; i++) { // ソートする配列を決める
            ...
            bs.bubbleSort(); // ソート
            if (isAscending(ary)) {
                System.out.printf("assign count:%4d", bs.getAssignCount());
                System.out.printf("\tcompare count:%4d", bs.getCompareCount());
            } else {
            ...
            if (isAscending(ary)) {
                System.out.printf("assign count:%4d", ss.getAssignCount());
                System.out.printf("\tcompare count:%4d", ss.getCompareCount());
            } else {
                System.out.print("Failed: " + Arrays.toString(ary));
            }
            System.out.println();
            ...
            shs.shellSort(); // ソート
            if (isAscending(ary)) {
                System.out.printf("assign count:%4d", shs.getAssignCount());
                System.out.printf("\tcompare count:%4d", shs.getCompareCount());
            } else {
                System.out.print("Failed: " + Arrays.toString(ary));
            }
            System.out.println();
            ...
            if (isAscending(ary)) {
                System.out.printf("assign count:%4d", is.getAssignCount());
                System.out.printf("\tcompare count:%4d", is.getCompareCount());
            } else {
                System.out.print("Failed: " + Arrays.toString(ary));
            }
            System.out.println();
            ...
            if (isAscending(ary)) {
                System.out.printf("assign count:%4d", qu.getAssignCount());
                System.out.printf("\tcompare count:%4d", qu.getCompareCount());
            } else {
                System.out.print("Failed: " + Arrays.toString(ary));
            }
            System.out.println();
            ...
            if (isAscending(ary)) {
                System.out.printf("assign count:%4d", iqu.getAssignCount());
                System.out.printf("\tcompare count:%4d", iqu.getCompareCount());
            } else {
                System.out.print("Failed: " + Arrays.toString(ary));
            }
            System.out.println();
    ...
    private static void init(int arraySize, long seed) {
        ...
        for (int i = 1; i < ascendingArray.length; i++) {
            ...
            // 1つ後より0--9小さい数
            descendingArray[descendingArray.length - 1 - i] = descendingArray[descendingArray.length - i]
                    + random.nextInt(10);
            // ランダム
